...
def main():
    ...
    # initiate node
    rospy.init_node('off_board', anonymous=True)
    ...
    st_sub = rospy.Subscriber('mavros/state', State, cnt.stateCb)

    # Subscribe to drone's local position
    sp_sub = rospy.Subscriber('mavros/local_position/pose', PoseStamped, cnt.posCb)
    
    #msg_sub = rospy.Subscriber('Test', PositionTarget, cnt.msgCb)
    lis_sub = rospy.Subscriber('chatter', PositionTarget, cnt.callback)
